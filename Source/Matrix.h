...
public:
	...
	static mat4 GenPerspective(float, float,float ,float);
...
inline mat4 Matrix::GenPerspective(float w, float h,float near, float far)
{
	ratio = w / h;
	return perspective(angle, ratio, near, far);
}
